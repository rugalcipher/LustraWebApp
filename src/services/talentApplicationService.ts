 ...
 * headers at all. An `Authorization` or `X-Application-Token` header on a
 * presigned PUT breaks the signature, and the object store has no business
 * seeing either credential.
 */
