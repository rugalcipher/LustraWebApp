 ...
 *
 * This is the shared address form used everywhere an address is entered. In the next pass a
 * Google Places selector is added on top of these fields (it fills them and marks the address
 * verified); the manual line 2 / unit / building / access-instruction fields always remain
 * separately editable. Inputs inherit the app's ≥16px mobile sizing, so focusing one never
 * triggers an iOS zoom.
 *
 * @param {{
 *   value: object,
